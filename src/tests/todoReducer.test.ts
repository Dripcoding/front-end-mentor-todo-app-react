...
describe("todo reducer", () => {
  it("creates todo", () => {
    const action = {
      type: CREATE_TODO,
      payload: { id: 2, text: "second todo", active: true },
    };
    const state = {
  ...
  it("edits todo", () => {
    const action = {
      type: EDIT_TODO,
      payload: { id: 2, text: "new todo text", active: true },
    };
    const state = {
      todos: [
  ...
  it("deletes todo", () => {
    const action = {
      type: DELETE_TODO,
      payload: { id: 1, text: "todo to delete", active: true },
    };
    const state = {
      todos: [
        { id: 1, text: "first todo", active: true },
  ...
  it("returns given state as the default behavior", () => {
    ...
    const action = {
      type: DEFAULT_ACTION,
      payload: { id: 1, text: "default", active: true },
    };
    const state = {
      todos: [
        { id: 1, text: "first todo", active: true },
  ...
  it("sets active state to false for a complete todo", () => {
    const action = {
      type: COMPLETE_TODO,
      payload: { id: 1, text: "first todo", active: true },
    };
    const state = {
      todos: [{ id: 1, text: "first todo", active: true }],
    };
  ...
  it("sets active state to true for an active todo", () => {
    const action = {
      type: ACTIVATE_TODO,
      payload: { id: 1, text: "example todo", active: false },
    };
    const state = {
      todos: [{ id: 1, text: "first todo", active: true }],
    };
  ...
  it("deletes all todos", () => {
    const action = {
      ...
      payload: { id: 1, text: "", active: false },
    };
    const state = {
      todos: [
        { id: 1, text: "first todo", active: true },
  ...
  it("shows all active todos", () => {
    const action = {
      type: VIEW_ALL_ACTIVE_TODOS,
      payload: { id: 1, text: "", active: false },
    };
    const state = {
      todos: [
